...
import { auth, createUserProfileDocument, getCurrentUser, googleProvider, githubProvider } from "../../firebase/firebaseUtils";
...
export function* onGithubSignInStart(){
	yield takeLatest(authActionTypes.GITHUB_SIGN_IN_START, signInWithGithub);
}
