...
const GITHUB_ASSETS_BASE_URL = "https://cdn.jsdelivr.net/gh/jackjona123/cosflix@assets";
export const LANG = "en-US";
export const REGION = "US";
export const BASE_IMG_URL = "https://image.tmdb.org/t/p/original";
export const FALLBACK_IMG_URL = `${GITHUB_ASSETS_BASE_URL}/fallback_image.png`;
export const LOGO_URL = `${GITHUB_ASSETS_BASE_URL}/cosflix_logo.png`;
export const MOBILE_LOGO_URL = `${GITHUB_ASSETS_BASE_URL}/favicon/android-chrome-192x192.png`;
export const PROFILE_PIC_URL = `${GITHUB_ASSETS_BASE_URL}/avatar.png`;
export const SIGNIN_BGIMG_URL = `${GITHUB_ASSETS_BASE_URL}/signin_bg.jpg`;
export const TADUM_SOUND_URL = `${GITHUB_ASSETS_BASE_URL}/babum.mp3`;
